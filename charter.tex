...
La ejecución de este proyecto va alineada con el interés del INTA de determinar el estado de la flor de los durazneros a partir de imagenes.
...
La solución que se propone hará uso de un modelo de detección de objetos óptimo para el problema planteado. Además, para la clasificación de flores, se utilizará un modelo pre-entrenado que se ajustará a las fotos proporcionadas. Al final, se tendrá como resultado todos los requisitos que se piden en la tabla 2. La figura 1 muestra esta solución a alto nivel.
...
\begin{itemize}
	...
	\item Se contará con soporte para temas no referentes al area de inteligencia artificial que se necesiten para la elaboración de este proyecto.
	\item Se tendrán imagenes con la calidad adecuada para resolver el problema planteado.
