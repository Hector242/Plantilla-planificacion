...
Req \#3.2. Las métricas que se utilizarán para la evaluación del modelo serán: \textit{mean average precision} (mAP), \textit{matriz de confusión}, \textit{precision}, \textit{recall}, \textit{F1}, \textit{accuracy}.
