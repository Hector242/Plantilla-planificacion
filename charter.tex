...
\fechaFINALTrabajo{14 de marzo de 2024}	%Fecha de defensa pública del trabajo final
...
\begin{enumerate}
	\item Requerimientos funcionales
		\begin{enumerate}
			...
			\item El algoritmo debe detectar la presencia de las varetas de los durazneros e identificar el tipo de flor que posee.			        \item El algoritmo debe identificar el estado fenológico de cada flor de duraznero en la vareta. Este estado puede ser F de flor abierta, E de flor cerrada o G de flor sin pétalos. 
	...
	\begin{enumerate}
			\item El modelo se evaluará con imágenes provenientes del mismo dataset de imágenes entregado por el cliente.
			 \item Las métricas que se utilizarán para la evaluación del modelo serán: \textit{mean average precision} (mAP), \textit{matriz de confusión}, \textit{precision}, \textit{recall}, \textit{F1}, \textit{accuracy}.
		\end{enumerate}
...
Descripción &
  ...
  \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}Valor total} \\ \hline
   \multicolumn{1}{|l|}{Horas del responsable} 
 &
  \multicolumn{1}{c|}{620} &
  \multicolumn{1}{c|}{US\$30} &
  \multicolumn{1}{c|}{US\$18.600} \\ \hline
   \multicolumn{1}{|l|}{Computadora personal} 
 &
  \multicolumn{1}{c|}{1} &
  \multicolumn{1}{c|}{US\$1000} &
  \multicolumn{1}{c|}{US\$1000} \\ \hline
\multicolumn{3}{|c|}{SUBTOTAL} &
  \multicolumn{1}{c|}{US\$19.600} \\ \hline
\rowcolor[HTML]{C0C0C0} 
...
\multicolumn{1}{|c|}{1}
   ...
   \\ \hline
\multicolumn{3}{|c|}{SUBTOTAL} &
  \multicolumn{1}{c|}{US\$110} \\ \hline
\rowcolor[HTML]{C0C0C0}
\multicolumn{3}{|c|}{TOTAL} &  \multicolumn{1}{c|}{US\$19.710} 
   \\ \hline
\end{tabularx}%
\end{table}
...
1. Datos insuficientes.      &   &   &     &    &    &      \\ \hline
2. Etiquetar incorrectamente los estados fenológicos de la flor.      &   &   &     &    &    &      \\ \hline
3. Falta de recursos.       &   &   &     &    &    &      \\ \hline
4. Bajo desempeño del modelo de aprendizaje.       &   &   &     &    &    &      \\ \hline
5. Mala interpretación de los requerimientos.       &   &   &     &    &    &      \\ \hline
\end{tabularx}%
\end{table}
