...
\begin{itemize}
	\item Verificación: proporcionar una imagen al modelo y verificar visualmente  que a la salida, tanto la imagen como el archivo en formato JSON contienen la correcta detección de la vareta y su tipo de flor.
...
\begin{itemize}
	\item Verificación: proporcionar una imagen al modelo y verificar visualmente  que a la salida, tanto la imagen como el archivo en formato JSON contienen los estados de las flores correctamente identificados.
...
\begin{itemize}
	\item Verificación: proporcionar una imagen al modelo y comprobar en el archivo en formato JSON de salida si el número total de flores detectadas por centímetro de vareta coincide con lo que se visualiza en la imagen.
...
\begin{itemize}
	\item Verificación: pasar una imagen por el modelo y a la salida obtener un archivo en formato JSON y una imagen con las detecciones.
